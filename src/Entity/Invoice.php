...
class Invoice
{
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\Type(type="DateTime", message="La date doit être renseignée au format YYYY-MM-DD")
    ...
    /**
     * Permet de récupérer le user de qui appartient finalement la facture
